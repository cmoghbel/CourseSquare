...
#import "CellPictureUpdateWrapper.h"
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [[[self.people objectAtIndex:indexPath.row] objectForKey:@"user"] objectForKey:@"firstName"];
...
-(UIImage *)imageForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *userID = [[[self.people objectAtIndex:indexPath.row] objectForKey:@"user"] objectForKey:@"id"];
    ...
    if(!image) {
        ...
        NSString *url = [[[self.people objectAtIndex:indexPath.row] objectForKey:@"user"] objectForKey:@"photo"];
